...
from model_runner import run_decision_tree_pipeline, run_random_forest_pipeline
...
def pipeline():
    ...
    if os.path.isfile("models/decision_tree_model.pkl"):
    ...
    if os.path.isfile("models/random_forest_model.pkl"):
        run_random_forest_pipeline(X_train, X_test, y_train, y_test, ["ham", "spam"], feature_names)
